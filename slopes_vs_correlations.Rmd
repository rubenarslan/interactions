...
## Fit LM
```{r}
model <- brm(OWB ~ Job_satisfaction*single_f + (1 + Job_satisfaction | id), data = diary, cores = 4, backend = "cmdstanr", file = "slopes_differ2")
...
## Fit LM
```{r}
model <- brm(OWB ~ Job_satisfaction*single_f + (1 + Job_satisfaction | id), data = diary, cores = 4, backend = "cmdstanr", file = "corrs_differ_not_slopes2")
...
## Fit LM
```{r}
model <- brm(OWB ~ Job_satisfaction*single_f + (1 + Job_satisfaction | id), data = diary, cores = 4, backend = "cmdstanr", file = "lower_pred_var3")
...
ggsave("job_satisfaction_singles.pdf", width = 5, height = 7)
ggsave("job_satisfaction_singles.png", width = 6, height = 7)
```
